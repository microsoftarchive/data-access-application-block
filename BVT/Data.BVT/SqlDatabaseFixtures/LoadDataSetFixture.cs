...
namespace Microsoft.Practices.EnterpriseLibrary.Data.BVT.SqlDatabaseFixtures
{
    ...
    public class LoadDataSetFixture : EntLibFixtureBase
    {
        ...
        public override void Initialize()
        {
            ...
            ItemLDSspparamXML = "LDSspparam.xml";
        ...
        [DeploymentItem(@"TestFiles\LDSspparam.xml")]
        ...
        #region "commandwarpper,dataset,string[]"
        ...
        #region "spname,dataset,string[],params[]"
        ...
        [DeploymentItem(@"TestFiles\LDSspparam.xml")]
        [DeploymentItem(@"TestFiles\LDSctspparam.xml")]
        public void RecordIsAddedWhenUsingStoredProcWithParameters()
        {
            Database db = DatabaseFactory.CreateDatabase("DataSQLTest");
            DataSet itemDataSet = new DataSet();
            string spName = "AddItem";
            db.LoadDataSet(spName, itemDataSet, new string[] { "Items" }, new object[] { 4, "Infotech", 88, 35, 100 });
            DataSet da = new DataSet();
            da.ReadXml(ItemLDSspparamXML);

            Assert.AreEqual(da.Tables[0].Rows[0][0].ToString().Trim(), itemDataSet.Tables[0].Rows[0][1].ToString().Trim());
        ...
        #region "transaction,sp,dataset,string[],param[]-commit,rollback"
        ...
        [DeploymentItem(@"TestFiles\LDSspparam.xml")]
        [DeploymentItem(@"TestFiles\LDSctspparam.xml")]
        public void RecordIsAddedWhenUsingStoredProcWithParametersAndTransactionCommit()
        {
            Database db = DatabaseFactory.CreateDatabase("DataSQLTest");
            DataSet itemDataSet = new DataSet();
            string spName = "Additem";
        ...
        [DeploymentItem(@"TestFiles\LDSspparam.xml")]
        [DeploymentItem(@"TestFiles\LDSctspparam.xml")]
        public void RecordIsNotAddedWhenUsingStoredProcWithParametersAndTransactionNotCommitted()
        {
            Database db = DatabaseFactory.CreateDatabase("DataSQLTest");
            DataSet itemDataSet = new DataSet();
            string spName = "Additem";
